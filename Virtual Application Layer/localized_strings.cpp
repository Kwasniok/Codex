...
void localized_strings::set(val::localized_strings* ls)
{
	current = ls;
}
...
bool val::create_localized_strings_from_file(val::localized_strings& ls, const std::string& file_path)
{
	bool good = false;
...
std::istream& operator>>(std::istream& is, val::localized_strings& ls)
{
	// language identifier:
	std::string lang_id;
	is >> lang_id;
...
std::ostream& operator<<(std::ostream& os, val::localized_strings& ls)
{
	// language identifier:
